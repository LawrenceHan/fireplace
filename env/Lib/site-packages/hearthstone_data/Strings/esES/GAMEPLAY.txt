...
GAMEPLAY_BACON_ALTERNATE_PLAYER_NAME	Con {0}	0=character hero name
...
GAMEPLAY_BACON_MULLIGAN_AVAILABLE_RACES	Tipos de esbirros en esta partida: {0}, {1}, {2}, {3}, {4}	0=first race, 1=second race, 2=third race, 3=fourth race, 4=fifth race
...
GAMEPLAY_BACON_SHOP_PHASE_NAME	Reclutamiento	
...
GAMEPLAY_PlayErrors_REQ_SECRET_ZONE_CAP	Solo puedes tener {0} secretos o misiones	
...
GAMEPLAY_PlayErrors_REQ_TARGET_WITH_RACE	No es la raza correcta	
GAMEPLAY_PlayErrors_REQ_TWO_OF_A_KIND	Debe tener una tercera copia disponible	
...
GAMEPLAY_TOOLTIP_BACON_DARKMOON_PRIZES_DESC	¡{0} |4(turno,turnos) para <b>Descubrir</b> uno de los premios de la Luna Negra de Bob!	
GAMEPLAY_TOOLTIP_BACON_DARKMOON_PRIZES_HEADLINE	Premios de la Luna Negra	
GAMEPLAY_TOOLTIP_BACON_GOLD	Gasta oro para comprar esbirros.	
