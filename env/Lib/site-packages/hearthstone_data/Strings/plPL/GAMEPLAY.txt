...
GAMEPLAY_BACON_DRAGSELL_BODY_TUTORIAL	Przeciągnij stronników do Boba, aby ich sprzedać.\n\nZwolnisz w ten sposób miejsce i otrzymasz 1 szt. złota!	
...
GAMEPLAY_PlayErrors_REQ_SECRET_ZONE_CAP	Możesz mieć maksymalnie {0} |4(sekret i zadanie,sekrety i zadania,sekretów i zadań)	
...
GAMEPLAY_PlayErrors_REQ_TARGET_WITH_RACE	To nie jest odpowiednia rasa	
GAMEPLAY_PlayErrors_REQ_TWO_OF_A_KIND	Musi mieć potencjalną trójkę	
...
GAMEPLAY_TOOLTIP_BACON_DARKMOON_PRIZES_DESC	Jeszcze {0} |4(tura,tury,tur) do <b>Odkrycia</b> jednej z Lunomrocznych nagród Boba!	
