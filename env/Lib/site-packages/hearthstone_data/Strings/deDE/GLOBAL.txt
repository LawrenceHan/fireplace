...
GLOBAL_CARD_SET_DMF	Der Dunkelmond-Wahnsinn	
GLOBAL_CARD_SET_DMF_SEARCHABLE_SHORTHAND_NAMES	dmf dmw	This is a space-separated list indicating all of the allowable search keywords that can be used in Collection Manager screen's text-search feature to narrow down the cards to this specific Card Set via shorthand names (note: the full name above is also used for this feature). Also note: letter case is ignored.
GLOBAL_CARD_SET_DMF_SHORT	Dunkelmond	
...
GLOBAL_ERROR_NETWORK_ACCOUNT_CURFEW_REACHED	[Suchtprävention] Aufgrund geltender nationaler Gesetze und Bestimmungen können sich minderjährige Spieler zwischen 22:00 Uhr und 8:00 Uhr des Folgetages nicht in das Spiel einloggen.	
GLOBAL_ERROR_NETWORK_ACCOUNT_PLAYTIME_EXCEEDED	[Suchtprävention] Aufgrund geltender nationaler Gesetze und Bestimmungen ist die tägliche Spielzeit für minderjährige Spieler auf 1,5 Stunden beschränkt. Dieses Limit wurde heute erreicht. Bitte planen Sie Ihre Spielzeit entsprechend.	
...
GLOBAL_FRIENDLIST_CHALLENGE_BUTTON_MODE_UNAVAILABLE	Einen Freund in diesem Spielmodus herauszufordern ist aktuell nicht möglich.	
...
GLOBAL_KEYWORD_CORRUPT	Verderben	
GLOBAL_KEYWORD_CORRUPT_TEXT	Wird auf der Hand aufgewertet, wenn Ihr eine Karte ausspielt, die mehr kostet.	
GLOBAL_KEYWORD_CORRUPTEDCARD	Verderbt	
GLOBAL_KEYWORD_CORRUPTEDCARD_TEXT	Wurde durch das Ausspielen einer Karte mit höheren Kosten aufgewertet.	
...
GLOBAL_MEDAL_TOOLTIP_BEST_RANK_STANDARD	Rang im Standardformat: {0}	
GLOBAL_MEDAL_TOOLTIP_BEST_RANK_WILD	Rang im wilden Format: {0}	
...
GLOBAL_MEDAL_TOOLTIP_BODY_STANDARD	Gewinnt Standardspiele, um den nächsten Rang zu erreichen!	
GLOBAL_MEDAL_TOOLTIP_BODY_WILD	Gewinnt wilde Spiele, um den nächsten Rang zu erreichen!	
...
GLOBAL_MOBILE_ERROR_UNSUPPORTED_IOS_PHONE_DETECTED	Es tut uns leid, für Hearthstone ist ein iPhone 6s, iPod Touch 7 oder ein neueres Gerät erforderlich.	
GLOBAL_MOBILE_ERROR_UNSUPPORTED_IOS_TABLET_DETECTED	Es tut uns leid, für Hearthstone ist ein iPad 5, iPad Air 2, iPad mini 4 oder neuer erforderlich.	
...
GLOBAL_PROGRESSION_ACHIEVEMENT_COMPLETION	{0} abgeschlossen	
...
GLOBAL_PROGRESSION_DAILY_QUESTS_POPUP_TITLE	Eure Quests	
GLOBAL_PROGRESSION_POINTS	{0} Erfolgspunkte	
GLOBAL_PROGRESSION_PROFILE_ARENA_STAT_TOOLTIP	Die meisten Siege in der Arena	
GLOBAL_PROGRESSION_PROFILE_ARENA_STAT_TOOLTIP_TITLE	Arenarekord	
GLOBAL_PROGRESSION_PROFILE_ARENA_WINS	{0} |4(Sieg,Siege)	
GLOBAL_PROGRESSION_PROFILE_BATTLEGROUNDS_STAT_TOOLTIP	Gewinnt Spiele im Schlachtfeldmodus, um Eure Wertung zu erhöhen.	
GLOBAL_PROGRESSION_PROFILE_BATTLEGROUNDS_STAT_TOOLTIP_TITLE	Schlachtfeldwertung	
GLOBAL_PROGRESSION_PROFILE_GAME_MODES	Spielmodi	
GLOBAL_PROGRESSION_PROFILE_PLAY_MODE	Modus „Spielen“	
GLOBAL_PROGRESSION_PROFILE_PVPDR_CASUAL_STAT_TITLE	Normale Duelle	
GLOBAL_PROGRESSION_PROFILE_PVPDR_CASUAL_STAT_TOOLTIP	Spielt normale Duelle, um Eure Wertung zu erhöhen.	
GLOBAL_PROGRESSION_PROFILE_PVPDR_CASUAL_STAT_TOOLTIP_TITLE	Wertung für normale Duelle	
GLOBAL_PROGRESSION_PROFILE_PVPDR_HEROIC_STAT_TITLE	Heroische Duelle	
GLOBAL_PROGRESSION_PROFILE_PVPDR_HEROIC_STAT_TOOLTIP	Spielt heroische Duelle, um Eure Wertung zu erhöhen.	
GLOBAL_PROGRESSION_PROFILE_PVPDR_HEROIC_STAT_TOOLTIP_TITLE	Wertung für heroische Duelle	
GLOBAL_PROGRESSION_PROGRESS_MESSAGE	{0} / {1}	
GLOBAL_PROGRESSION_QUEST_TIME_UNTIL_NEXT	Neue Quest in {0}	
GLOBAL_PROGRESSION_RANKED_REWARDS_TOOLTIP	Verdient in jeder Saison Belohnungen für Euren besten Rang im wilden Format oder im Standardformat.	
GLOBAL_PROGRESSION_RANKED_REWARDS_TOOLTIP_TITLE	Gewertete Belohnungen	
GLOBAL_PROGRESSION_REWARD_SUMMARY	{0}\n{1}	
GLOBAL_PROGRESSION_REWARD_TRACK_XP	{0} Belohnungserfahrung	
GLOBAL_PROGRESSION_TIER_MESSAGE	{0}/{1}	
GLOBAL_PROGRESSION_TOOLTIP_GOLDEN_WINS_DESC	Gewinnt als {0} 500 Spiele im gewerteten Modus oder in der Arena, um den entsprechenden goldenen Basishelden freizuschalten!	{0}=class name
GLOBAL_PROGRESSION_TOOLTIP_HERO_LEVEL_NEXT_REWARD	Nächste {0}-Karte auf Stufe {1}	{0}=premium {1}=level
GLOBAL_PROGRESSION_TOOLTIP_PREMIUM_WINS_DESC	Gewinnt als {0} 1.000 Spiele im gewerteten Modus oder in der Arena, um {1} freizuschalten!	{0}=class name {1}=hero card name
GLOBAL_PROGRESSION_TOOLTIP_TOTAL_CLASS_WINS	{0} Siege insgesamt	{0}=class name
GLOBAL_PROGRESSION_WEEKLY_QUESTS_POPUP_TITLE	Eure wöchentlichen Quests	
...
GLOBAL_REWARD_ARENA_TICKET_TITLE	Gasthaus	
